...
export default function Navigation(/*{ component, fields }*/{setNavigation}) {

    // console.log('nav', fields)
    
    return ( 
        <div className="bg-lightGray fixed w-full p-5 h-full overflow-auto animate-slide shadow-lg shadow-gray" >
                    {/* <div className="bg-lightGray fixed w-full p-5 md:w-1/2 h-full overflow-auto animate-slide" ></div> */}
            <div className="flex flex-col font-bold text-2xl py-7 pl-5 gap-4">
